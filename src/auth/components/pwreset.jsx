    ...
    <div className='resetPage'>
      ...
      <div className='resetleft'>
        <div className="resetleftSub">
          ...
          <p id="resetp">
            {success
              ? `We've  sent a password reset link to ${email}. Click the link to reset your password. If you don't see it in your inbox, check your spam folder.`
          ...
          <div className="resaskSign askSign">
            <p>{success ? 'Go back to' : 'Remember your password?'}{' '}
