...
const Resetlink = () => {
  return (
    ...
    <p id='sentpass'>We have sent a password reset link to <br/> <a href="me@gmail.com">me@gmail.com</a><br/> Click the link to reset your password. If you don't <br/>see it in your inbox, check your inbox folder.</p>
    
        <p id="recievemail">Didn't Recieve Email?</p>
        <input type="submit" id='resetlinksubmit'value="Resend Link" />
        <div className="asklogin"> <p>Remember your password?  <Link to="/login">Log in</Link></p></div>
        </div>
