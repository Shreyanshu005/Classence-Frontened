...
const Calendar = () => {
  ...
  return (
    <div className={`mt-[1.5rem] bg-[#E1EAE8]  transition-all duration-300 ease-in-out ${isPageLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`} style={{ marginLeft: sidebarWidth,transition: 'margin-left 0.3s ease,translate 0.3 ease'}}>
